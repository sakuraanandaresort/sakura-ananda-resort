...
export async function sendEmail(to:string,subject:string,html:string,text:string){
  ...
  // Brevo is the preferred provider for V3. It uses the Brevo HTTP API,
  // which works directly from a Vercel server function.
  ...
  // Backward-compatible Resend support.
  ...
  return {sent:false,reason:'Email is not configured. Add BREVO_API_KEY and BREVO_FROM_EMAIL in Vercel.'};
}
