...
begin
  ...
  insert into public.reservations(
    ...
    payment_ref,payment_proof_url,status,special_requests
  ) values (
    ...
    'Pending',nullif(trim(coalesce(p_special_requests,'')),'')
...
revoke all on function public.create_public_reservation(text,text,text,date,date,integer,uuid,numeric,text,text,text,text) from public;
grant execute on function public.create_public_reservation(text,text,text,date,date,integer,uuid,numeric,text,text,text,text) to anon,authenticated;
