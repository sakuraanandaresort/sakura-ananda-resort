...
export default function Reservation() {
  ...
  const [f, setF] = useState({
    ...
    /*
     * This is the amount the guest says they paid.
  ...
  useEffect(() => {
    ...
    async function loadData() {
       ...
       *
       * IMPORTANT:
       * We use r.name for the visible room name.
       *
       * Example:
       *
       * Room 1
  ...
  async function submit(
    ...
    /*
     * Deposit entered by guest.
     *
     * If empty:
     * use suggested deposit.
     *
     * IMPORTANT:
     ...
     *
     * payment_status is intentionally initialized
     * as "Unpaid".
     *
     * Staff will verify the payment from the
     * admin dashboard and click "Mark as Paid".
     */
    const payload = {
      ...f,
